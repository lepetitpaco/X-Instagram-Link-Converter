@echo off
REM Script pour créer le package Firefox (Manifest V2) prêt à publier - Windows
...
set PACKAGE_NAME=x-instagram-link-converter-firefox
set TEMP_DIR=.firefox-package
...
copy manifest-v2.json "%TEMP_DIR%\manifest.json" >nul
